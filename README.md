...
| [`new-growing-products-in-category`](skills/new-growing-products-in-category/SKILL.md) | Finds new, already-selling listings in a category (recently listed, well rated, with real sales) as a product table. | "new products in category", "what's launching and already selling", "recent best-sellers" | "produtos novos na categoria", "novos anúncios que já vendem", "lançamentos em alta" |
