...
| [`category-top-100-change-tracker`](skills/category-top-100-change-tracker/SKILL.md) | Weekly change tracker for a category's top ~100 sellers, adding a per-seller week-over-week movement column and the biggest movers. | "track top sellers weekly", "seller ranking changes", "who moved up or down" | "acompanhar os principais vendedores", "ranking semanal de vendedores", "quem subiu ou caiu na categoria" |
