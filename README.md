...
| [`top-sellers-in-category`](skills/top-sellers-in-category/SKILL.md) | Ranks the top sellers in a category by estimated average revenue — a single point-in-time leaderboard with full seller stats. | "top sellers in this category", "biggest stores in a category", "rank sellers by revenue" | "principais vendedores da categoria", "maiores lojas da categoria", "quem mais vende nessa categoria" |
